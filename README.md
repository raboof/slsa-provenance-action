...
```sh
docker run philipssoftware/slsa-provenance:v0.6.1-draft
```
...
```sh
docker run ghcr.io/philips-labs/slsa-provenance:v0.6.1-draft
```
  ...
  provenance:
    ...
    steps:
      - name: Generate provenance for Release
        uses: philips-labs/slsa-provenance-action@v0.6.1-draft
        with:
          command: generate
          subcommand: files
